    ...
    >
      ...
      <div className="grid grid-cols-4 gap-4 bg-white px-4 py-3 items-center">
        ...
        <div className="text-center text-sm text-gray-900 font-medium">
          {formatCurrency(ExpenseCalculator.getTotalYear1(expense))}
        </div>
        <div className="text-center text-sm text-gray-900 font-medium">
          {formatCurrency(ExpenseCalculator.getTotalYear2(expense))}
        </div>
        <div className="text-center text-sm text-gray-900 font-medium">
          {formatCurrency(ExpenseCalculator.getTotalYear3(expense))}
        </div>
      </div>
    </div>
  );
